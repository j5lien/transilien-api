...
const formatTrains = require('./format.js');
...
TransilienApi.prototype.nextDepartures = function(trainStation) {
  return this
    .get(`/gare/${trainStation}/depart/`)
    .then(results => results.passages.train ? formatTrains(results.passages.train) : []);
};
...
TransilienApi.prototype.nextDeparturesToDestination = function(departureTrainStation, destinationTrainStation) {
  return this
    .get(`/gare/${departureTrainStation}/depart/${destinationTrainStation}/`)
    .then(results => results.passages.train ? formatTrains(results.passages.train) : []);
};
